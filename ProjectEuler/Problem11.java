	...
	public static void main(String[] args) {
		...
		for (int i = 0; i <= 19; i++) {
			for (int j = 0; j <= 16; j++) {
				...
				for (int k = 0; k <= 3; k++) {
					int m = j * 3;
					Produkt *= Long.parseLong(Grid[i].substring(m + k * 3, m + (k + 1) * 3 - 1));
				}
				if (Produkt > Grosste) {
					Grosste =  Produkt;
				}
		...
		for (int i = 0; i <= 19; i++) {
			for (int j = 0; j <= 16; j++) {
				long Produkt = 1;
				for (int k = 0; k <= 3; k++) {
					Produkt *= Long.parseLong(Grid[j + k].substring(0, 2));
				}
				if (Produkt > Grosste) {
					Grosste =  Produkt;
				}
		...
		for (int i = 0; i <= 16; i++) {
			for (int j = 0; j <= 16; j++) {
				...
				for (int k = 0; k <= 3; k++) {
					int m = j * 3;
					Produkt *= Long.parseLong(Grid[i + k].substring(m + k * 3, m + (k + 1) * 3 - 1));
				}
				if (Produkt > Grosste) {
					Grosste = Produkt;
				}
		...
		for (int i = 0; i <= 16; i++) {
			for (int j = 0; j <= 16; j++) {
				...
				for (int k = 0; k <= 3; k++) {
					int m = j * 3;
					Produkt *= Long.parseLong(Grid[i + k].substring(57 - (m + k * 3), 61 - (m + (k + 1) * 3 - 1)));
				}
				if (Produkt > Grosste) {
					Grosste = Produkt;
				}
		...
		/*
		 * Problem solved
		 * 249780th person to have solved this problem
		 * Difficulty rating: 5%
		 * */
	}
}
